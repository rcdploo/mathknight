...
export const monsterAttackPatterns: MonsterAttackPatternDefinition[] = [
  ...
  { name: "Prime", hasSpells: false, difficulty: 1, description: "Attack with rising prime numbers" },
...
export const monsterTypes: MonsterTypeDefinition[] = [
  ...
  { name: "Witch", hpMultiplier: 0.96, complexity: "Basic", spellcasting: "Always", spells: ["Heal", "Cripple 1", "Weaken 2", "Energy Drain 2"] },
  ...
  { name: "Fiend", hpMultiplier: 1.06, complexity: "Basic", spellcasting: "Sometimes", spells: ["Cripple 1", "Enrage", "Energy Drain 1"] },
  { name: "Orc", hpMultiplier: 1.1, complexity: "Basic", spellcasting: "Never", spells: [] },
  { name: "Enchantress", hpMultiplier: 0.9, complexity: "Medium", spellcasting: "Always", spells: ["Heal", "Addle 2", "Confound 2", "Weaken 3"] },
  { name: "Sorcerer", hpMultiplier: 0.94, complexity: "Medium", spellcasting: "Always", spells: ["Usurp 2", "Energy Drain 2", "Weaken 3", "Confound 2"] },
  { name: "Djinn", hpMultiplier: 0.96, complexity: "Medium", spellcasting: "Always", spells: ["Cripple 1", "Addle 2", "Immolation 1"] },
  { name: "Slime", hpMultiplier: 1.06, complexity: "Medium", spellcasting: "Rarely", spells: ["Heal", "Weaken 3", "Energy Drain 2"] },
  ...
  { name: "Umbralith", hpMultiplier: 1, complexity: "Medium", spellcasting: "Sometimes", spells: ["Energy Drain 2", "Confound 1", "Cripple 1"] },
  ...
  { name: "Lich", hpMultiplier: 0.93, complexity: "Tough", spellcasting: "Always", spells: ["Enrage", "Confound 2", "Weaken 3", "Brainrot 2"] },
  ...
  { name: "Demon", hpMultiplier: 1.03, complexity: "Tough", spellcasting: "Sometimes", spells: ["Usurp 2", "Heal", "Energy Drain 2"] },
