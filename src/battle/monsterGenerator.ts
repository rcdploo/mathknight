...
const baseDamage: Record<DungeonLevel, Record<DungeonRoom, number | null>> = {
  ...
  2: { 1: 10, 2: 12, 3: 12, 4: 12, 6: 14, 7: 15, 8: 15, 9: 17, Boss: 20 },
  3: { 1: 17, 2: 20, 3: 20, 4: 18, 6: 23, 7: 26, 8: 26, 9: 29, Boss: 35 },
  4: { 1: 29, 2: 34, 3: 34, 4: 27, 6: 39, 7: 44, 8: 44, 9: 49, Boss: 59 },
  5: { 1: 50, 2: 58, 3: 58, 4: 41, 6: 67, 7: 75, 8: 75, 9: 84, Boss: 100 },
};

const baseHp: Record<DungeonLevel, Record<DungeonRoom, number | null>> = {
  1: { 1: 30, 2: 32, 3: 35, 4: 37, 6: 40, 7: 44, 8: 47, 9: 50, Boss: 125 },
  2: { 1: 60, 2: 64, 3: 70, 4: 65, 6: 80, 7: 88, 8: 94, 9: 100, Boss: 250 },
  3: { 1: 120, 2: 128, 3: 140, 4: 114, 6: 160, 7: 176, 8: 188, 9: 200, Boss: 500 },
  4: { 1: 240, 2: 256, 3: 280, 4: 200, 6: 320, 7: 352, 8: 376, 9: 400, Boss: 1000 },
